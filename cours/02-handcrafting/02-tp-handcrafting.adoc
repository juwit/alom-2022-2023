...
Initialisez un repository Github avec ce lien : https://classroom.github.com/a/o70p2cXI
...
NOTE: Prenez bien la 'Binary Distribution', si vous prenez la source vous devrez compiler Tomcat vous-même ! Sous Linux, privilégiez le format `.tar.gz`, qui conserve les bons droits sur les fichiers.
